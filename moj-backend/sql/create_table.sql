...
(
    ...
    tags        varchar(1024)                      null comment '题目知识点（json 数组）',
    ques_tags   varchar(1024)                      null comment '题目难度（json 数组）',
...
(
    ...
    status     int      default 0                 not null comment '判题状态0-待判题，1 - 判题中 2-成功 3-失败',
